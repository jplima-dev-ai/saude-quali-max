...
Na versão 3.8.6, confirme também que imagens WebP continuam decodificáveis, que todas as miniaturas dos produtos existem e que o conjunto de imagens não ultrapassa o limite registrado em `tools/test-v368.py` sem justificativa documental.
