...
Cada versão deve renovar o identificador do cache e listar os novos recursos essenciais. Na versão atual, confirme `qualimax-v3.8.8` em `service-worker.js`; nunca reutilize o identificador de uma versão anterior.
