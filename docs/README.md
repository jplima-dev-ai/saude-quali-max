...
Documentação técnica e operacional da versão **3.8.5**. Este diretório funciona como manual oficial do projeto: os guias descrevem o estado publicado, enquanto decisões anteriores permanecem no changelog.
...
| [Evidências 3.8.5](QUALITY-EVIDENCE-V383.md)          | Matriz executada e limitações                            |
