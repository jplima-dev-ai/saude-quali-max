...
Documentação técnica e operacional da versão **3.9.0**. Este diretório funciona como manual oficial do projeto: os guias descrevem o estado publicado, enquanto decisões anteriores permanecem no changelog.
...
| [Apresentação do repositório](REPOSITORY-PRESENTATION.md) | About, topics, Social Preview e leitura por recrutadores |
| [Release 3.9.0](RELEASE-NOTES-V390.md)                    | Destaques e limites da versão                            |
...
| [Evidências 3.9.0](QUALITY-EVIDENCE-V390.md)              | Matriz executada e contratos da release                  |
