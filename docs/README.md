...
Documentação técnica e operacional da versão **3.8.9**. Este diretório funciona como manual oficial do projeto: os guias descrevem o estado publicado, enquanto decisões anteriores permanecem no changelog.
...
| [Evidências 3.8.9](QUALITY-EVIDENCE-V389.md)          | Matriz executada e limitações                            |
