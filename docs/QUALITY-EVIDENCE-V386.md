# Evidência de qualidade — v3.8.6

A manutenção 3.8.6 corrige a diferença entre o ambiente local e runners limpos do GitHub Actions. Os testes Python usam `lxml`, portanto a dependência agora é declarada e instalada de forma reproduzível.
