#!/usr/bin/env python3
"""Portfolio, social metadata, metrics and release contracts for 3.8.7."""
...
require(config.get("versao") == routes.get("version") == package.get("version") == metrics.get("version") == "3.8.7", "versões divergentes")
...
if errors:
    print("v3.8.7 FAILED\n" + "\n".join(errors))
    sys.exit(1)
print("v3.8.7 OK: portfólio, métricas, SEO social, PWA e release validados")
