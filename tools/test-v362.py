#!/usr/bin/env python3
"""Auditoria de responsividade e regressão da versão 3.8.5."""
...
def main():
    ...
    for page in pages:
        ...
        require(html.count("responsive-v362.css") == 1, f"CSS 3.8.5 ausente ou duplicado: {page}")
        require(html.count("responsive-v362.js") == 1, f"JS 3.8.5 ausente ou duplicado: {page}")
    ...
    require("qualimax-v3.8.5" in sw and "responsive-v362.css" in sw and "responsive-v362.js" in sw, "cache incompleto")
    print("v3.8.5 OK: 81 páginas e contratos responsivos validados")
