#!/usr/bin/env python3
"""Valida os contratos responsivos da versão 3.8.9."""
...
def main() -> None:
    ...
    check('qualimax-v3.8.9' in sw, "cache da versão não atualizado")
    check("responsive-v357.css" in sw and "responsive-v357.js" in sw, "assets fora do cache")
    print(f"OK: contratos responsivos 3.8.9 validados em {len(PAGES)} páginas")
