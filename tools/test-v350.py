...
assert config["versao"]=="3.6.4"
assert routes["version"]=="3.6.4"
...
assert "admin-products-v350.js" in sw and "qualimax-v3.6.4" in sw
print("v3.6.4 OK: central profissional de produtos integrada")
