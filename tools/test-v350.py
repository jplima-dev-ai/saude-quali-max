...
assert config["versao"]=="3.8.5"
assert routes["version"]=="3.8.5"
...
assert "admin-products-v350.js" in sw and "qualimax-v3.8.5" in sw
print("v3.8.5 OK: central profissional de produtos integrada")
