...
assert config["versao"]=="3.9.0"
assert routes["version"]=="3.9.0"
...
assert "admin-products-v350.js" in sw and "qualimax-v3.9.0" in sw
print("v3.9.0 OK: central profissional de produtos integrada")
