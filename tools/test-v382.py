...
require('qualimax-v3.8.5' in worker, 'cache PWA 3.8.5 ausente')
...
require((ROOT/'docs/QUALITY-EVIDENCE-V382.md').is_file(), 'evidência 3.8.5 ausente')
if errors:
    print('v3.8.5 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.8.5 OK: correção ARIA do catálogo, versionamento e cache validados')
