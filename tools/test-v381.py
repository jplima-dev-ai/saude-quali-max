#!/usr/bin/env python3
"""Patch contracts for release 3.8.9."""
...
require(package.get("version") == config.get("versao") == routes.get("version") == metrics.get("version") == "3.8.9", "versões 3.8.9 divergentes")
...
require('saude-qualimax-v3.8.9' in packager, "empacotador ainda aponta para release anterior")
require((ROOT / "docs/QUALITY-EVIDENCE-V381.md").is_file(), "evidência 3.8.9 ausente")

if errors:
    print("v3.8.9 FAILED\n" + "\n".join(errors))
    sys.exit(1)
print("v3.8.9 OK: contraste do CTA, versionamento, cache e higiene de release validados")
