"""Contratos de imagens, desempenho e versão da Saúde Qualimax 3.8.6."""
...
require(f'qualimax-v{VERSION}' in worker, "cache sem versão 3.8.6")
...
if errors:
    print("v3.8.6 FAILED\n" + "\n".join(errors))
    sys.exit(1)
print(f"v3.8.6 OK: 120 WebP, {total_bytes} bytes, 60 produtos e entrega adaptativa validados")
