"""Contratos de imagens, desempenho e versão da Saúde Qualimax 3.9.0."""
...
require(f'qualimax-v{VERSION}' in worker, "cache sem versão 3.9.0")
...
if errors:
    print("v3.9.0 FAILED\n" + "\n".join(errors))
    sys.exit(1)
print(f"v3.9.0 OK: 120 WebP, {total_bytes} bytes, 60 produtos e entrega adaptativa validados")
