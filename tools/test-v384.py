#!/usr/bin/env python3
"""Regression contracts for wellness contrast in release 3.9.0."""
...
require((ROOT/'docs/QUALITY-EVIDENCE-V384.md').is_file(),'evidência 3.9.0 ausente')
require('## [3.9.0]' in (ROOT/'docs/CHANGELOG.md').read_text(encoding='utf-8'),'changelog 3.9.0 ausente')
if errors:
    print('v3.9.0 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.9.0 OK: contraste wellness, versionamento e cache validados')
