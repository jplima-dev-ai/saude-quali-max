#!/usr/bin/env python3
"""Regression contracts for wellness contrast in release 3.8.9."""
...
require((ROOT/'docs/QUALITY-EVIDENCE-V384.md').is_file(),'evidência 3.8.9 ausente')
require('## [3.8.9]' in (ROOT/'docs/CHANGELOG.md').read_text(encoding='utf-8'),'changelog 3.8.9 ausente')
if errors:
    print('v3.8.9 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.8.9 OK: contraste wellness, versionamento e cache validados')
