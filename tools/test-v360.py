...
def main() -> None:
    ...
    require(config["versao"] == routes["version"] == settings["version"] == "3.9.0", "versões divergentes")
    ...
    for token in ("qualimax-v3.9.0", "wellness-hub.html", "data/v360.json", "platform-v360.js", "admin-v360.js"):
    ...
    print("v3.9.0 OK: dez módulos da Central de Bem-Estar validados")
