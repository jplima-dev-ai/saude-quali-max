...
def main() -> None:
    ...
    require(config["versao"] == routes["version"] == settings["version"] == "3.8.7", "versões divergentes")
    ...
    for token in ("qualimax-v3.8.7", "wellness-hub.html", "data/v360.json", "platform-v360.js", "admin-v360.js"):
    ...
    print("v3.8.7 OK: dez módulos da Central de Bem-Estar validados")
