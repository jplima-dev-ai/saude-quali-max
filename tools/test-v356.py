...
if cfg.get("versao")!="3.8.5":errors.append("versão incorreta")
...
for page in root.glob("*.html"):
    ...
    if "chatbot.js" in h and "max-reasoning-v356.js" not in h:errors.append(f"Max 3.8.5 ausente: {page.name}")
...
print("v3.8.5 OK: copy humana, 60 produtos e raciocínio contextual validados")
