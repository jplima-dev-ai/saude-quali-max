...
if cfg.get("versao")!="3.9.0":errors.append("versão incorreta")
...
for page in root.glob("*.html"):
    ...
    if "chatbot.js" in h and "max-reasoning-v356.js" not in h:errors.append(f"Max 3.9.0 ausente: {page.name}")
...
print("v3.9.0 OK: copy humana, 60 produtos e raciocínio contextual validados")
