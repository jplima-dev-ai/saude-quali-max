...
def main():
    ...
    require("qualimax-v3.8.6" in sw and "privacy.html" in sw and "privacy-v363.css" in sw and "privacy-v363.js" in sw, "cache de privacidade incompleto")
    sitemap = (ROOT / "sitemap.xml").read_text(encoding="utf-8")
    require("/privacy.html" in sitemap, "Política fora do sitemap")
    print("v3.8.6 OK: política white-label integrada e 81 páginas validadas")
