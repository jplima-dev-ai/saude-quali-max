#!/usr/bin/env python3
"""Regression contracts for Playwright stability in release 3.8.7."""
...
require((ROOT/'docs/QUALITY-EVIDENCE-V383.md').is_file(),'evidência 3.8.7 ausente')
if errors:
    print('v3.8.7 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.8.7 OK: Playwright serial, retry local, versionamento e cache validados')
