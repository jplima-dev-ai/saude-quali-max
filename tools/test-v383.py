#!/usr/bin/env python3
"""Regression contracts for Playwright stability in release 3.9.0."""
...
require((ROOT/'docs/QUALITY-EVIDENCE-V383.md').is_file(),'evidência 3.9.0 ausente')
if errors:
    print('v3.9.0 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.9.0 OK: Playwright serial, retry local, versionamento e cache validados')
