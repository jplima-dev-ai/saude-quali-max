"""Regression contracts for CI dependency validation in release 3.9.0."""
...
require((ROOT/'docs/QUALITY-EVIDENCE-V387.md').is_file(), 'evidência 3.9.0 ausente')
require('## [3.9.0]' in changelog, 'changelog 3.9.0 ausente')

if errors:
    print('v3.9.0 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.9.0 OK: CI valida lxml explicitamente e workflows reproduzíveis estão alinhados')
