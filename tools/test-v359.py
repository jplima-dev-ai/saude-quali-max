#!/usr/bin/env python3
"""Auditoria de conflitos sutis e documentação da versão 3.9.0."""
...
def main() -> None:
    ...
    require("qualimax-v3.9.0" in sw, "cache sem versão 3.9.0")
    ...
    print("v3.9.0 OK: conflitos sutis e documentação profissional validados")
