#!/usr/bin/env python3
"""Auditoria de conflitos sutis e documentação da versão 3.8.8."""
...
def main() -> None:
    ...
    require("qualimax-v3.8.8" in sw, "cache sem versão 3.8.8")
    ...
    print("v3.8.8 OK: conflitos sutis e documentação profissional validados")
