#!/usr/bin/env python3
"""Auditoria de conflitos sutis e documentação da versão 3.8.6."""
...
def main() -> None:
    ...
    require("qualimax-v3.8.6" in sw, "cache sem versão 3.8.6")
    ...
    print("v3.8.6 OK: conflitos sutis e documentação profissional validados")
