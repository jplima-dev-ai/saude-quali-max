#!/usr/bin/env python3
"""Auditoria de conflitos sutis e documentação da versão 3.8.9."""
...
def main() -> None:
    ...
    require("qualimax-v3.8.9" in sw, "cache sem versão 3.8.9")
    ...
    print("v3.8.9 OK: conflitos sutis e documentação profissional validados")
