#!/usr/bin/env python3
"""Contratos de estabilização responsiva da versão 3.8.9."""
...
def main() -> None:
    ...
    require(json.loads((ROOT / "data/config.json").read_text(encoding="utf-8"))["versao"] == "3.8.9", "config sem versão")
    sw = (ROOT / "service-worker.js").read_text(encoding="utf-8")
    require("qualimax-v3.8.9" in sw and "responsive-v358.css" in sw and "responsive-v358.js" in sw, "cache incompleto")
    print("v3.8.9 OK: zoom extremo, teclado virtual, tabelas e overflow validados em 81 páginas")
