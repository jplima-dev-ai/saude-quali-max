#!/usr/bin/env python3
"""Auditoria integral e contratos do avatar Max 3.8.6."""
...
def main() -> None:
    ...
    require("qualimax-v3.8.6" in sw, "cache desatualizado")
    ...
    print("v3.8.6 OK: 81 páginas, links, assets e avatar do Max validados")
