#!/usr/bin/env python3
"""Auditoria integral e contratos do avatar Max 3.9.0."""
...
def main() -> None:
    ...
    require("qualimax-v3.9.0" in sw, "cache desatualizado")
    ...
    print("v3.9.0 OK: 81 páginas, links, assets e avatar do Max validados")
