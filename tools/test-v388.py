"""Regression contracts for Axe contrast fixes in release 3.8.9."""
...
require('qualimax-v3.8.9' in worker,'cache PWA 3.8.9 ausente')
...
require((ROOT/'docs/QUALITY-EVIDENCE-V388.md').is_file(),'evidência 3.8.9 ausente')
require('## [3.8.9]' in (ROOT/'docs/CHANGELOG.md').read_text(encoding='utf-8'),'changelog 3.8.9 ausente')
if errors:
    print('v3.8.9 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.8.9 OK: contrastes Axe do Admin e Privacidade, versionamento e cache validados')
