"""Contratos de estabilidade e regressão da versão 3.8.8."""
...
require('qualimax-v3.8.8' in worker, "cache sem versão 3.8.8")
...
require("configuracao-animacoes-v3.8.8.json" in animations, "exportação de animações desatualizada")
require("configuracao-animacoes-v3.3.4.json" not in animations, "nome antigo na exportação de animações")

if errors:
    print("v3.8.8 FAILED\n" + "\n".join(errors))
    sys.exit(1)
print("v3.8.8 OK: 81 páginas, recursos e regressões sutis validados")
