"""Contratos de estabilidade e regressão da versão 3.8.5."""
...
require('qualimax-v3.8.5' in worker, "cache sem versão 3.8.5")
...
require("configuracao-animacoes-v3.8.5.json" in animations, "exportação de animações desatualizada")
require("configuracao-animacoes-v3.3.4.json" not in animations, "nome antigo na exportação de animações")

if errors:
    print("v3.8.5 FAILED\n" + "\n".join(errors))
    sys.exit(1)
print("v3.8.5 OK: 81 páginas, recursos e regressões sutis validados")
