#!/usr/bin/env python3
"""Regression contracts for reproducible GitHub Actions dependencies in release 3.8.9."""
...
require((ROOT/'docs/QUALITY-EVIDENCE-V386.md').is_file(),'evidência 3.8.9 ausente')
require('## [3.8.9]' in (ROOT/'docs/CHANGELOG.md').read_text(encoding='utf-8'),'changelog 3.8.9 ausente')
if errors:
    print('v3.8.9 FAILED\n'+'\n'.join(errors)); sys.exit(1)
print('v3.8.9 OK: dependências Python reproduzíveis e workflows CI/Pages/Release validados')
